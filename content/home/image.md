...
<script type="text/javascript">
  $(document).ready(function (){
    $('#image').append("<img class='ballon' src='/pic/sun.jpeg' id='bg_img'><span id='welcome_str' class='fade' style='position: absolute; top: 0; left: 0;'>WELCOME TO SRI'S LAB</span><div id='arraw' style='position: absolute;'><span class='arraw'></span><div>");
    ...
    $('#array').css('top', $(window).height() - $('#welcome_str').width() - 80);
